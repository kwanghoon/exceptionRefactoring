...
import android.widget.ExceptionEditText;
 ...
 */
public class NoteEditor extends ExceptionActivity {
     ...
     */
    public static class LinedEditText extends ExceptionEditText {
        private Rect mRect;
        private Paint mPaint;

        // This constructor is used by LayoutInflater
        public LinedEditText(Context context, AttributeSet attrs) {
            super((ExceptionActivity)context, attrs); // Issue: Difficult to figure out the purpose of this casting.
        ...
        protected void OnDraw(Canvas canvas) {
            ...
            //super.onDraw(canvas); // Issue: A mismatch in the convention.
        }
    }
    ...
    public boolean OnCreateOptionsMenu(Menu menu) throws Throwable {
        ...
        return super.OnCreateOptionsMenu(menu); // Issue: handling return values.
    }
    ...
    public boolean OnPrepareOptionsMenu(Menu menu) throws Throwable {
        ...
        return super.OnPrepareOptionsMenu(menu); // Issue: handling return values.
    }
