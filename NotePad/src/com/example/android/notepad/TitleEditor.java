 ...
 */
public class TitleEditor extends ExceptionActivity {
    ...
    public void onClickOk(View v) { // Issue: how do we prepare OnClickOk in advance?
    	try {                    // A solution: User-defined try/catch block!
    		finish();
    	} catch(Throwable exn) {
    		Throw(exn);
    	}
